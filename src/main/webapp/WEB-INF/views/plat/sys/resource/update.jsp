...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            <form id="resouceForm" name="resouceForm" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 ">
                        <select name="target" class="col-xs-10 col-sm-5">
                            ...
                            <option value="_blank" <c:if test="${sysResource.target eq '_blank'} "> selected</c:if>>_blank
                            </option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input id="iconImg" type="text" name="iconImg" class="col-xs-10 col-sm-5"
                               placeholder="" value="${sysResource.iconImg }"><label
                            id="iconImgTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input id="description" type="text" name="description" class="col-xs-10 col-sm-5" placeholder=""
                               value="${sysResource.description }"><label id="descriptionTip"></label>
                    </div>
                </div>
                <div class="form-group">
